...
// Asegúrate de que los íconos estén correctamente importados
          ...
          <>
            ...
            <View className="mx-4 flex justify-around flex-1 mb-2">
              ...
              <View className="flex-row justify-center">
                <Image
                  source={
                    weatherIconsIA[current?.condition?.text] ||
                    weatherIconsIA["other"]
                  }
                  className="w-52 h-52"
                  resizeMode="contain"
                />
              ...
              >
                {weather?.forecast?.forecastday?.map((item, index) => {
                  ...
                  return (
                    <View
                      key={index}
                      className="flex justify-center items-center w-32 rounded-3xl py-4 space-y-2 mr-2"
                      style={{ backgroundColor: theme.bgWhite(0.15) }}
                    >
                      <Image
                        source={
                          weatherImages[
                            normalizeConditionText(item?.day?.condition?.text)
                          ] || weatherImages["other"]
                        }
                        className="h-16 w-16"
                        resizeMode="contain"
